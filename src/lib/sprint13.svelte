...
<main>
    <h2 id="sprint13">Sprint 13</h2>
    <ul class="weekOverzicht">
        <li><h3><a href="#week1">Week 1</a></h3></li>
        <li><h3><a href="#week2">Week 2</a></h3></li>
        <li><h3><a href="#week3">Week 3</a></h3></li>
    </ul>

    <article>
        <div id="week1">
            <h2 class="week" >Week 1</h2>

            <div class="learningQuestions">
                <h3>Leervragen</h3>
                <ol>
            ...
            <div class="weekPlanning">
                ...
                <ul>
                    <li>Schets gekozen
                        <ul>
                            <li>
                                <a href="https://github.com/KaanKalmi/your-tribe-for-life-squad-page/issues/3">Zie issue voor onze schetsen</a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul>
                    ...
                    <li>Feedback geschreven in issues jaar 1
                        <ul>
                    ...
                    <li>
                        <a href="https://github.com/fdnd-task/your-tribe-for-life-squad-page/commit/da2301c2dfc7db790e0b8db3f42ae31b7fe23d7f">Zie mijn push/ commit</a>
                    </li>
                    <li>Feedback geven aan Squadpagina jaar 2
                        <ul>
        ...
        <div id="week2">
            ...
            <div class="weekPlanning">
                ...
                <ul>
                  ...
                  <li><a href="#weloveweb1">We love Web Vasilis van Gemert</a></li>
